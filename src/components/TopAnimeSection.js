...
import AnimeBanner from '../assets/AnimeBanner2.jpg'
...
export default function TopAnimeSection(props) {
    ...
    return (
        <>
            {isError ? <h1 className='text-white text-center p-5'>Message From Top Banner: <br /><br /><i className="fa-solid fa-warning" style={{ color: "#FF0000" }} /> Failed to Fetch Data</h1> : animeList ?
